        ...
        <div className="mt-16 grid gap-8 max-w-2xl mx-auto">
          ...
          >
            ...
            {!showEmailForm && !formSubmitted && (
              <motion.a
                href={isYearly 
                  ? "https://spilll.lemonsqueezy.com/buy/257635ee-f50c-4a3a-b487-effbccb1c8b3?embed=1&media=0&discount=1&discount_form=1&checkout_options[discount]=true" 
                  : "https://spilll.lemonsqueezy.com/buy/8a0e0990-c94e-49d0-9ecd-483f7b45de51?embed=1&media=0&discount=1&discount_form=1&checkout_options[discount]=true"}
